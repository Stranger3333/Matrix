         ...
         <form onSubmit={this.handleSubmit}>
                <div>
                    <Form.Group as={Row} className="mb-3" controlId="formHorizontalUsername">
                        ...
                        <Col sm={10}>
                            <Form.Control required type="text" placeholder="Username" value={this.state.username} onChange={this.handleUsernameRegistration}  />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="formHorizontalEmail">
                        ...
                        <Col sm={10}>
                            <Form.Control type="email" placeholder="Email" value={this.state.email} onChange={this.handleEmailRegistration} required />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="formHorizontalPassword">
                        ...
                        <Col sm={10}>
                            <Form.Control type="text" placeholder="Password" value={this.state.password} onChange={this.handlePasswordRegistration} required />
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="formHorizontalBirthday">
                        ...
                        <Col sm={10}>
                            <Form.Control type="date" id="birthday" onChange={this.handleBirthdayRegistration} required />
                        </Col>
                    </Form.Group>
